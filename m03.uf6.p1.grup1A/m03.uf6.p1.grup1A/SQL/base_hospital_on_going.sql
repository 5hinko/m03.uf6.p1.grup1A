CREATE DATABASE hospital_grup1;
CREATE USER 'admin_hospital_grup1'@'localhost' IDENTIFIED BY 'admin';
GRANT ALL PRIVILEGES ON hospital_grup1.* TO 'admin_hospital_grup1'@'localhost';
CREATE USER 'usuari_hospital_grup1'@'localhost' IDENTIFIED BY 'usuari';
GRANT SELECT ON hospital_grup1.* TO 'usuari_hospital_grup1'@'localhost';
FLUSH PRIVILEGES;
USE hospital_grup1;
